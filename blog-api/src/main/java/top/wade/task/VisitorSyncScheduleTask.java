...
import static top.wade.constant.RedisKeyConstants.IDENTIFICATION_SET;

/**
 * @Author xjw
 * @Date 2023/8/12 21:32
...
public class VisitorSyncScheduleTask {
    ...
    public void syncVisitInfoToDatabase() {
        ...
        redisService.deleteCacheByKey(IDENTIFICATION_SET);
        //获取昨天的所有访问日志
