...
public class ScheduleJob extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        top.wade.entity.ScheduleJob scheduleJob = (top.wade.entity.ScheduleJob) jobExecutionContext.getMergedJobDataMap().get(top.wade.entity.ScheduleJob.JOB_PARAM_KEY);
        //获取spring bean
