...
/**
 * @Author xjw
 * @Date 2023/7/15 18:17
 * @Description: 评论工具类
 */
@Component
@DependsOn("springContextUtils") //在初始化当前 Bean 之前，要先初始化名为 "springContextUtils" 的 Bean
public class CommentUtils {
     ...
     * @param admin   博主信息
     */
     public void setGeneralAdminComment (Comment comment, User admin) {
     ...
     */
     public void judgeSendNotify(Comment comment, boolean isVisitorComment, top.wade.entity.Comment parentComment) {
     ...
     * @param comment       当前收到的评论
     */
    private void sendMailToParentComment(top.wade.entity.Comment parentComment, Comment comment) {
